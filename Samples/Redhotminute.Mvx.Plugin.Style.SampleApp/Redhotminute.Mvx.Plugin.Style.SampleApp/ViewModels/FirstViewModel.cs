        ...
        : MvxViewModel
    {
		...
		private void LoadStyle1() {
            ...
            AssetProvider.AddFont(new Font() { Name = FontH1, FontFilename = "JosefinSlab-Thin.ttf", FontPlatformName = "JosefinSlab-Thin", Size = 40,LineHeight=20, Color = AssetProvider.GetColor(ColorSecondairy) })
                         ...
                         .AddFont(new Font() { Name = FontRegularSmall, FontFilename = "Nunito-Regular.ttf", FontPlatformName = "Nunito-Regular", Size = 12, LineHeight = 12,LineHeightMultiplier = 1.25f,Color = AssetProvider.GetColor(ColorPrimary), SelectedColor = AssetProvider.GetColor(ColorBackground) }, _tags);//10 23
		}                               
