		...
		protected override void SetValueImpl(object target, object value)
		{
			...
			if (font != null){
				try {
					...
					Mvx.Trace(MvvmCross.Platform.Platform.MvxTraceLevel.Error, "Failed to set font to UIButton. Check if font exists, has a size and filename, and is added to the plist");
				}
			}
		}
	}
